    ...
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-6xl px-4 pt-20 pb-24 text-center">
        ...
        <p className="mt-6 text-lg text-white/70 max-w-3xl mx-auto">
          AI-powered location analysis for smarter business decisions. Analyze demand, 
          competition, and risk factors to find the perfect spot for your next venture.
        ...
        <div className="mt-10 flex items-center justify-center gap-4">
          <Link
            ...
            className="btn-pill inline-flex items-center gap-2 rounded-2xl px-5 py-3
                       ...
                       shadow-glow"
          >
            <span className="font-medium">Analyze Location</span>
